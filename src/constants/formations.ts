...
export const FORMATIONS = [
  ...
  },
  {
    name: "4-4-2",
    positions: [
      { id: PlayerPosition.GK, x: 10, y: 50 },
      { id: PlayerPosition.LB, x: 30, y: 20 },
      { id: PlayerPosition.LCB, x: 30, y: 35 },
      { id: PlayerPosition.RCB, x: 30, y: 65 },
      { id: PlayerPosition.RB, x: 30, y: 80 },
      { id: PlayerPosition.LM, x: 55, y: 20 },
      { id: PlayerPosition.LCM, x: 55, y: 35 },
      { id: PlayerPosition.RCM, x: 55, y: 65 },
      { id: PlayerPosition.RM, x: 55, y: 80 },
      { id: PlayerPosition.LT, x: 80, y: 35 },
      { id: PlayerPosition.RT, x: 80, y: 65 },
    ],
  },
  {
    name: "3-5-2",
    positions: [
      { id: PlayerPosition.GK, x: 10, y: 50 },
      { id: PlayerPosition.LCB, x: 30, y: 25 },
      { id: PlayerPosition.CB, x: 30, y: 50 },
      { id: PlayerPosition.RCB, x: 30, y: 75 },
      { id: PlayerPosition.LWB, x: 55, y: 15 },
      { id: PlayerPosition.LCDM, x: 45, y: 35 },
      { id: PlayerPosition.RCDM, x: 45, y: 65 },
      { id: PlayerPosition.RWB, x: 55, y: 85 },
      { id: PlayerPosition.CAM, x: 70, y: 50 },
      { id: PlayerPosition.LT, x: 80, y: 30 },
      { id: PlayerPosition.RT, x: 80, y: 70 },
    ],
  },
];
