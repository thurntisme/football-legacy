...
export async function GET(request: NextRequest) {
  try {
    ...
    // Call external API to get transfer market players
    ...
    if (!ok) {
      return NextResponse.json(
        { message: "Failed to fetch transfer market players", success: false },
        { status },
      );
    }
    ...
    console.error("Get transfer market players error:", error);
    return NextResponse.json(
