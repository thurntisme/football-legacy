...
export default function TeamScouting() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Team Scouting</CardTitle>
          <CardDescription>
            Analyze your players' strengths, weaknesses, and performance metrics
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {filteredPlayers.length > 0 ? (
                  filteredPlayers.map((player) => (
                    <TableRow key={player.id}>
                      ...
                      <TableCell>{getFormBadge(player.form)}</TableCell>
                      <TableCell className={getFitnessColor(player.fitness)}>
                        {player.fitness}%
                      </TableCell>
                      <TableCell>{getMoraleBadge(player.morale)}</TableCell>
                      <TableCell>
                        {getScoutingLevelStars(player.scoutingLevel)}
                      </TableCell>
          ...
          {selectedPlayer && (
            <>
                    ...
                    >
                      ...
                      <TabsContent value="attributes" className="space-y-4">
                        ...
                        <Card>
                          ...
                          <CardContent>
                            <p className="text-sm">
                              Based on {selectedPlayer.name}'s attribute
                              profile, training should focus on:
                            </p>
                            <ul className="mt-2 space-y-1 text-sm">
                              ...
                              {selectedPlayer.attributes.shooting < 70 && (
                                <li className="flex items-center">
                                  <TrendingUp className="h-4 w-4 text-blue-500 mr-2" />
                                  <span>
                                    Enhancing shooting accuracy through
                                    finishing drills
                                  </span>
                                </li>
                              )}
                              ...
                              {Object.values(selectedPlayer.attributes).every(
                                ...
                                <li className="flex items-center">
                                  ...
                                  <span>
                                    ...
                                    maintaining balance while enhancing
                                    strengths.
                                  </span>
                                </li>
                              )}
                        ...
                        <Card>
                          ...
                          <CardContent>
                            <p className="text-sm">
                              ...
                              {selectedPlayer.stats.appearances} appearances
                              this season, playing a total of{' '}
                              ...
                              {selectedPlayer.position !== 'GK' &&
                                selectedPlayer.stats.tacklesPerGame < 1.5 && (
                                  <li className="flex items-center">
                                    <TrendingUp className="h-4 w-4 text-blue-500 mr-2" />
                                    <span>
                                      Work on defensive contribution and
                                      tackling technique
                                    </span>
                                  </li>
                                )}
                              ...
                              {['CM', 'CAM', 'LW', 'RW'].includes(
                                ...
                                selectedPlayer.stats.assists < 5 && (
                                  <li className="flex items-center">
                                    <TrendingUp className="h-4 w-4 text-blue-500 mr-2" />
                                    <span>
                                      Work on creative passing and chance
                                      creation
                                    </span>
                                  </li>
                                )}
                              {selectedPlayer.position === 'GK' &&
                                ...
                                selectedPlayer.stats.cleanSheets < 5 && (
                                  <li className="flex items-center">
                                    <TrendingUp className="h-4 w-4 text-blue-500 mr-2" />
                                    <span>
                                      Focus on improving shot-stopping and
                                      command of area
                                    </span>
                                  </li>
                                )}
                                ...
                                <ul className="mt-1 space-y-1 text-sm">
                                  {selectedPlayer.attributes.pace > 80 && (
                                    <li className="flex items-center">
                                      ...
                                      <span>
                                        Utilize their pace with through balls
                                        and counter-attacks
                                      </span>
                                    </li>
                                  )}
              ...
              <DialogFooter>
                ...
                <Button onClick={() => setShowPlayerDetails(false)}>
                  Close
                </Button>
              </DialogFooter>
            </>
